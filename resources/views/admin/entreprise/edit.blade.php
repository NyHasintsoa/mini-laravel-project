<x-layouts.app :title="__('Nouvelle Entreprise')">
    ...
    <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 mx-auto"><!-- Card -->
        <div class="bg-white rounded-xl shadow-xs p-4 sm:p-7 dark:bg-neutral-800">
            ...
            <form action="{{ route('admin.entreprises.update', ['entreprise' => $data->id]) }}" method="post">
                @csrf
                @method("PUT")
                <!-- Grid -->
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <x-input type='text' name='phone' value="{{ $data->phone }}" />
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <x-input type='text' name='activity' value="{{ $data->activity }}" />
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Grid -->
