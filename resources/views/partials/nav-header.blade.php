            ...
            <div class="col-12 col-md-10 col-lg-9 pr-md-0">
                <nav class="navbar navbar-expand-md btco-hover-menu py-lg-2">
                    ...
                    <a class="navbar-brand pl-0" href="index.html">
                        <img width="200" height="200" src="/images/logo/nav-logo.png" alt="Fables Template" class="fables-logo">
                    </a>
                    ...
                    <style>
                        ...
                        .fables-logo {
                            max-width: 100%;
                            /* Ensure the logo scales with its container */
                            height: auto;
                        ...
                        @media (max-width: 768px) {
                            .fables-logo {
                                max-width: 150px;
                                /* Smaller logo for tablets and smaller devices */
                            }
                        }
                        ...
                        @media (max-width: 480px) {
                            .fables-logo {
                                max-width: 120px;
                                /* Even smaller logo for mobile devices */
                            }
                        }

                        /* Optional: Adjust padding or margins for the navbar brand */
                        .navbar-brand.pl-0 {
                            padding-left: 0;
                        ...
                        <ul class="navbar-nav mx-auto fables-nav">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sub-nav1">
                                    ...
                                    <li><a class="dropdown-item" href="home4.html">Home </a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sub-nav3">
                                    ...
                                    <li><a class="dropdown-item" href="about2.html">Expertise</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sub-nav4">
                                    ...
                                    <li><a class="dropdown-item" href="store_single.html">Checkout</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sub-nav5">
                                    <li><a class="dropdown-item" href="blog-cat1.html">Recrutment</a></li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="sub-nav6" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    Pages
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="sub-nav6">
                                    ...
                                    <li><a class="dropdown-item" href="gallery-timeline.html">Services</a></li>
                                    <!-- <li><a class="dropdown-item" href="gallery-timeline2.html">Gallery Timeline 2</a></li> -->
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="sub-nav7" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    Contact
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="sub-nav7">
                                    <li><a class="dropdown-item" href="contactus1.html">Contact Us</a></li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <div class="p-3 cart-block">
                                ...
                                <div class="row mx-0 mb-3">
                                    ...
                                    <div class="col-8">
                                        <h2><a href="#"
                                                class="fables-main-text-color font-13 d-block fables-main-hover-color">Conseil
                                                statistique</a></h2>
                                        <p class="fables-second-text-color font-weight-bold">$ 5</p>
                                ...
                                <div class="row mx-0 mb-3">
                                    ...
                                    <div class="col-8">
                                        <h2><a href="#"
                                                class="fables-main-text-color font-13 d-block fables-main-hover-color">Resulat
                                                enquêtes</a></h2>
                                        <p class="fables-second-text-color font-weight-bold">$ 5</p>
                                        <p class="fables-forth-text-color">QTY : 1</p>
                                    </div>
                                ...
                                <span class="font-14 semi-font fables-second-text-color float-right">$10</span>
                                <hr>
